...
abstract class PlayerUtils
{
    ...
    public static function bumpPlume(Player $player): void {
        ...
        $motion->add((int)Core::getInstance()->getConfig()->getNested("bump.x", 1), (int)Core::getInstance()->getConfig()->getNested("bump.y", 1), (int)Core::getInstance()->getConfig()->getNested("bump.z", 1));
