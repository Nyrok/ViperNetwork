...
namespace Nyrok\LobbyCore\Forms\variant;


use Closure;
use JetBrains\PhpStorm\ArrayShape;
use Nyrok\LobbyCore\Forms\element\Element;
use Nyrok\LobbyCore\Forms\Form;
use Nyrok\LobbyCore\Forms\utils\Closable;
...
class CustomForm extends Form {
    ...
    #[ArrayShape(["content" => "\Nyrok\LobbyCore\Forms\element\Element[]"])] protected function serializeBody(): array {
        return [
